    ...
    <TecnologiesContainer>
      <TechnologieWithOverlay>
        ...
        <div>
          <h3>ReactJS</h3>
          <p>
            O ReactJS é uma biblioteca JavaScript para criação de interfaces de
            usuário reativas e eficientes. Ele utiliza componentes reutilizáveis
            e atualização seletiva da interface, proporcionando um desempenho
            otimizado. Com uma sintaxe JSX e uma comunidade ativa, o ReactJS é
            amplamente utilizado e suportado por diversas ferramentas e
            bibliotecas.
          </p>
        </div>
      </TechnologieWithOverlay>
      <TechnologieWithOverlay>
        ...
        <div>
          <h3>PHP</h3>
          <p>
            O PHP é uma linguagem de programação de código aberto amplamente
            usada para desenvolvimento web. Com uma sintaxe semelhante ao HTML,
            ele permite criar páginas dinâmicas, interagir com bancos de dados e
            processar formulários. O PHP possui uma comunidade ativa e extensa
            documentação, tornando-o uma escolha popular para construir
            aplicativos web.
          </p>
        </div>
      </TechnologieWithOverlay>
      <TechnologieWithOverlay>
        ...
        <div>
          <h3>NodeJs</h3>
          <p>
            O Node.js é uma plataforma de desenvolvimento de aplicações backend
            em JavaScript. Ele utiliza o motor de execução V8 do Google Chrome
            para executar o JavaScript no servidor. O Node.js é conhecido por
            sua natureza assíncrona e orientada a eventos, o que o torna
            eficiente e adequado para aplicações de alto desempenho em tempo
            real. Com um vasto ecossistema de pacotes e bibliotecas, o Node.js é
            amplamente utilizado para construir servidores, APIs e aplicativos
            web escaláveis.
          </p>
        </div>
      </TechnologieWithOverlay>
      ...
      <TechnologieWithOverlay>
        ...
        <div>
          <h3>PostgreSQL</h3>
          <p>
            O PostgreSQL é um poderoso sistema de gerenciamento de banco de
            dados relacional de código aberto. Ele fornece recursos avançados,
            como suporte a transações ACID, consultas complexas, indexação
            eficiente e extensibilidade, tornando-o uma escolha popular para
            aplicativos que requerem armazenamento de dados robusto.
          </p>
        </div>
      </TechnologieWithOverlay>
      <TechnologieWithOverlay>

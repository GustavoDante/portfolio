const technologiesTranslations = {
  en: {
    ...
    php: {
      experience: '1 year and a half of experience',
      description:
    ...
    typescript: {
      experience: '2 year and a half of experience',
      description:
...
export const translations = {
  en: {
    'about-me': {
      title: 'About me',
      text: 'I am currently a full-stack developer and actively involved in all stages of software development. From planning the technologies to deploying in the cloud and conducting tests. I have a strong desire to learn and enjoy working in a team, always focused on producing readable and organized code. I am a calm person and passionate about programming logic, constantly attentive to the latest trends in my field and technologies that can improve my productivity and the quality of the projects I am involved in.',
    },
    contacts: {
      whatsapp: 'Whatsapp',
      linkedin: 'Linkedin',
      ...
      jobs: [
        {
          ...
          description:
            'I work in the development of web applications, where I frequently used technologies such as Node.js, React.js, Nest.js, PostgreSQL, PrismaJs, Firebase, JavaScript, CSS, Laravel, PHP, MySQL, HTML and Blade. During my work, I was responsible for deploying on Google Cloud, both in the testing phase and in production, ensuring an efficient and reliable delivery of the projects. When dealing with customer feedback, I developed solutions to reported problems, seeking quick and effective solutions to ensure customer satisfaction. I used the PostgreSQL and MySQL databases in these projects.',
        },
        {
          ...
          company: 'Softmakers Br',
          description:
            'I worked in the development of web applications using a set of technologies, including Laravel, PHP, MySQL, HTML, Blade, JavaScript and CSS. I use GitHub and GitFlow to version projects, ensuring efficient source code control. In addition, I have knowledge of deploying on the Hostgator platform, both in the test environment and in production. In implementing solutions, I integrated external APIs such as PagSeguro to offer payment options within the platform. I used the MySql database in these projects.',
        },
      ],
    },
    degrees: {
      title: 'Certifications and Degrees',
    },
    projects: {
      title: 'My Projects',
      calcbet: {
      ...
      watchgather: {
        description:
          'Project developed to find movies and series to watch using The Movie Database API. I used NextJs, TypeScript, TailwindCss and among others.',
      },
    },
    feedbacks: {
      ...
      linkedin: [
        {
          name: 'Arthur Brito (UX/UI Designer | Product Designer)',
  ...
  pt: {
    ...
    projects: {
      ...
      watchgather: {
        description:
          'Projeto desenvolvido para achar filmes e séries para assistir utilizando a API do The Movie Database. Utilizei NextJs, TypeScript, TailwindCss e entre outros.',
      },
    },
    feedbacks: {
      title: 'Recomendações',
      linkedin: [
        ...
        {
          name: 'Luis Manoel (Desenvolvedor Web FullStack)',
          url: 'https://www.linkedin.com/in/luis-manoel-6ba027122/',
          description:
